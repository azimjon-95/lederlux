...
const AdminDashboard = () => {
    ...
    const handleLogout = () => {
        try {
            ...
            setIsLoggedIn(false);
            navigate(`/${lang}/admin/servoce`); // Redirect to login page
        ...
        <div className="dash-container">
            ...
            <div className="dash-main">
                ...
                <main className="dash-content">
                    {activeTab === 'admins' && <AdminsTable lang={lang} searchTerm={searchTerm} />}
                    {activeTab === 'products' && <ProductsTable lang={lang} searchTerm={searchTerm} />}
                    {activeTab === 'contacts' && <ContactsTable lang={lang} searchTerm={searchTerm} />}
                </main>
            </div>
