...
const ContactsTable = ({ lang, searchTerm = '' }) => {
    ...
    const validateForm = () => {
        const newErrors = {};
        if (!formData.salesDepartment.trim()) newErrors.salesDepartment = t.salesDepartmentRequired;
        if (!formData.exportDepartment.trim()) newErrors.exportDepartment = t.exportDepartmentRequired;
        if (!formData.purchaseDepartment.trim()) newErrors.purchaseDepartment = t.purchaseDepartmentRequired;
        if (!formData.hrDepartment.trim()) newErrors.hrDepartment = t.hrDepartmentRequired;
    ...
    const filteredContacts = contacts?.innerData?.filter(contact =>
        contact.salesDepartment.toLowerCase().includes(searchTerm.toLowerCase()) ||
        contact.exportDepartment.toLowerCase().includes(searchTerm.toLowerCase()) ||
        contact.purchaseDepartment.toLowerCase().includes(searchTerm.toLowerCase()) ||
        ...
        <div className="vfo-contacts-container">
            ...
            {error && (
                <div className="vfo-error">
                    ...
                    <button className="vfo-btn vfo-btn-primary vfo-btn-sm" onClick={refetch}>
                        {t.retry || 'Retry'}
                    </button>
                </div>
            )}
                                        ...
                                        <td>
                                            <div className="vfo-actions">
                                                ...
                                                <button
                                                    ...
                                                    disabled={isDeleting || isUpdating}
                                                >
                                                    {isDeleting ? <Loader2 size={14} className="vfo-spinner" /> : <Trash2 size={14} />}
                                                </button>
                                            </div>
                                        </td>
                                    </tr>
                ...
                <div className="vfo-modal-overlay" onClick={closeModal}>
                    <div className="vfo-modal" onClick={e => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmit} className="vfo-form">
                            <div className="vfo-form-grid">
                                <div className="vfo-form-group">
                                    ...
                                    <input
                                        ...
                                        className={`vfo-input ${errors.salesDepartment ? 'vfo-input-error' : ''}`}
                                        placeholder={t.salesDepartment}
                                    />
                                    {errors.salesDepartment && <span className="vfo-error">{errors.salesDepartment}</span>}
                                </div>
                                ...
                                <div className="vfo-form-group">
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className={`vfo-input ${errors.exportDepartment ? 'vfo-input-error' : ''}`}
                                        placeholder={t.exportDepartment}
                                    />
                                    {errors.exportDepartment && <span className="vfo-error">{errors.exportDepartment}</span>}
                                </div>
                                ...
                                <div className="vfo-form-group">
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className={`vfo-input ${errors.purchaseDepartment ? 'vfo-input-error' : ''}`}
                                        placeholder={t.purchaseDepartment}
                                    />
                                    {errors.purchaseDepartment && <span className="vfo-error">{errors.purchaseDepartment}</span>}
                                </div>
                            ...
                            {errors.submit && (
                                <div className="vfo-error-message">
                                    {errors.submit}
                                </div>
                            )}
