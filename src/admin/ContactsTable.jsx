...
const translations = {
  en: {
    ...
    turkeyBranch: "Office in Turkey, Istanbul",
    infoDesk: "Info Desk",
    reception: "Reception",
    actions: "Actions",
    edit: "Edit",
    ...
    hrDepartmentRequired: "Office in Turkey, Istanbul is required",
  ...
  ru: {
    ...
    turkeyBranch: "Офис в Турции, Стамбул",
    ...
    hrDepartmentRequired: "Офис в Турции, Стамбул обязателен",
  ...
  uz: {
    ...
    turkeyBranch: "Turkiya Istanbul ofisi",
    ...
    hrDepartmentRequired: "Turkiya Istanbul ofisi majburiy",
