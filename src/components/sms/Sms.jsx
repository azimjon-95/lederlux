...
import { User, Phone, MessageCircle, Send, Star, CheckCircle } from 'lucide-react';
import './style.css';
...
const ContactForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const botToken = 'BOT_TOKEN_HERE'; // O'zingizning bot tokeningizni qo'ying
            const chatId = 'CHAT_ID_HERE'; // Guruh yoki kanal ID sini qo'ying
            ...
            const messageText = `
                ...
                ${feedback.telegram ? `📱 *Telegram:* @${feedback.telegram}` : ''}
            ...
            if (response.ok) {
                ...
                setIsSubmitted(true);
                setFeedback({ name: '', phone: '', telegram: '', description: '', rating: 5 });
            } else {
