...
import { toggleSearchPanel, setSearchQuery } from '../../context/actions/authSearch'; // Adjust path as needed
    ...
    return (
        <header className="bez-header">
            <div className="bez-header-top-content">
                ...
                <a href="mailto:info@liderlux.uz" className="bez-contact-info">
                    <Mail size={16} />
                    <span>info@liderlux.uz</span>
                </a>
            </div>
