...
function ProductSinglePage() {
    ...
    const lang = localStorage.getItem('lang') || localStorage.getItem('lang') || 'ru'; // Default to Russian if no language is set
                        ...
                        {product.images && product.images.length > 1 && (
                            <div className="bez-thumbnails">
                                {product.images.map((image, index) => (
                                    <div
                                        key={index}
                                        className={`bez-thumbnail ${currentImageIndex === index ? 'bez-active' : ''}`}
                                        onClick={() => handleImageChange(index)}
                                    >
                                        <img
                                            src={image}
                                            alt={`${product.title?.[lang] || product.title?.ru || 'Product'} ${index + 1}`}
                                            onError={(e) => {
                        ...
                        <div className="bez-single-title-section">
                            ...
                            <div className="bez-single-price">
                                ...
                                <span className="bez-price-value">
                                    {product.price ? `${product.price.toLocaleString()} ${selectedLang.currency}` : 'N/A'}
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="bez-single-specs">
                            ...
                            <div className="bez-specs-grid">
                                <div className="bez-spec-item">
                                    ...
                                    <p>{product.applicationAreas?.[lang] || product.applicationAreas?.ru || 'N/A'}</p>
                                </div>
                                ...
                                <div className="bez-spec-item">
                                    ...
                                    <p>{product.usageMethod?.[lang] || product.usageMethod?.ru || 'N/A'}</p>
                                </div>
                                ...
                                <div className="bez-spec-item">
                                    ...
                                    <p>{product.safetyRequirements?.[lang] || product.safetyRequirements?.ru || 'N/A'}</p>
                                </div>
                                ...
                                <div className="bez-spec-item">
                                    ...
                                    <p>{product.manufacturerWarranty?.[lang] || product.manufacturerWarranty?.ru || 'N/A'}</p>
                                </div>
                                ...
                                <div className="bez-spec-item">
                                    ...
                                    <p>{product.storageAndTransport?.[lang] || product.storageAndTransport?.ru || 'N/A'}</p>
                                </div>
                            </div>
                        </div>
