...
const translations = {
    uz: {
        header: {
            title: "Natriy Nitrat",
            subtitle: "Texnik natriyli azot kislotasi tuz",
        ...
        application: {
            ...
            overview: "Natriy nitrat (chili selitra) kimyo, shisha, metallurgiya va boshqa sanoat tarmoqlari uchun mo'ljallangan.",
            gradeA: {
                title: "A Markasi",
    ...
    ru: {
        header: {
            title: "Натрий Нитрат",
            subtitle: "Техническая соль азотной кислоты",
            chemicalFormula: "NaNO₃",
            badges: {
                toxic: "Токсично",
        ...
        application: {
            ...
            overview: "Натрий нитрат (чилийская селитра) предназначен для химической, стекольной, металлургической и других отраслей промышленности.",
            gradeA: {
                title: "Марка А",
    ...
    en: {
        header: {
            ...
            subtitle: "Technical nitric acid salt",
            chemicalFormula: "NaNO₃",
            badges: {
                toxic: "Toxic",
        ...
        application: {
            ...
            overview: "Sodium nitrate (Chile saltpeter) is intended for chemical, glass, metallurgical, and other industries.",
            gradeA: {
                title: "Grade A",
                        ...
                        <div className="cards-grid">
                            <div className="card grade-a-card">
                                <div className="card-header">
                                    ...
                                    >
                                        {expandedCards.gradeA ? <ChevronUp size={20} /> : <ChevronDown size={20} />}
                                    </button>
                                </div>
                                <div className={`card-content ${expandedCards.gradeA ? 'expanded' : ''}`}>
                                    <p><strong>{t.application.gradeA.text}</strong></p>
                                    <ul>
                            ...
                            <div className="card grade-b-card">
                                <div className="card-header">
                                    ...
                                    >
                                        {expandedCards.gradeB ? <ChevronUp size={20} /> : <ChevronDown size={20} />}
                                    </button>
                                </div>
                                <div className={`card-content ${expandedCards.gradeB ? 'expanded' : ''}`}>
                                    <p><strong>{t.application.gradeB.text}</strong></p>
                                    <ul>
                            ...
                            <div className="card liquid-card">
                                ...
                                <div className="card-content">
                                    <div className="recipe">
                                        <p><strong>{t.usage.liquid.recipe.title}</strong></p>
                                        <p>{t.usage.liquid.recipe.text}</p>

                                        <div className="measurements">
                                            <h4>{t.usage.liquid.recipe.measurements.title}</h4>
                                            <ul>
                                                {t.usage.liquid.recipe.measurements.items.map((item, index) => (
                                                    <li key={index}>{item}</li>
                                                ))}
                                            </ul>
                                        </div>
                            ...
                            <div className="card safety-reminder-card">
                                ...
                                <div className="card-content">
                                    <div className="safety-points">
                                        <p><strong>{t.usage.safety.text}</strong></p>
                                        <ul>
